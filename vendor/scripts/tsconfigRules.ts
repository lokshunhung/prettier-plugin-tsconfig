// https://github.com/microsoft/TypeScript-Website/blob/58683ff1bef022a85e79446844e53e250d03260a/packages/tsconfig-reference/scripts/tsconfigRules.ts
/* eslint-disable */
// @ts-nocheck
...
export const deprecated: CompilerOptionName[] = ["out", "charset", "keyofStringsOnly", "noErrorTruncation", "diagnostics"];
...
export const allowedValues = {
    ...
    target: ["`ES3` (default)", "`ES5`", "`ES6`/`ES2015` (synonomous)", "`ES7`/`ES2016`", "`ES2017`", "`ES2018`", "`ES2019`", "`ES2020`", "`ESNext`"],
    module: [
    ...
    fallbackPolling: ["fixedPollingInterval", "dynamicPriorityPolling", "useFsEvents", "synchronousWatchDirectory"],
...
export const releaseToConfigsMap: {[key: string]: AnOption[]} = {
    ...
    "3.8": ["assumeChangesOnlyAffectDirectDependencies", "importsNotUsedAsValues", "disableSolutionSearching", "fallbackPolling", "watchDirectory", "watchFile"],
    ...
    "1.8": ["allowJs", "allowSyntheticDefaultImports", "allowUnreachableCode", "allowUnusedLabels", "noImplicitReturns", "noFallthroughCasesInSwitch"],
